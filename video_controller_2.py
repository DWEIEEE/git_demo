...
#QtGui模块涵盖多种基本图形功能的类。
#QPixmap 是專門處理繪圖的類別，顯示影像到螢幕裝置上 
#QImage 是專門處理影像 pixel 像素的類別
from PyQt5.QtCore import QTimer 
#QTimer 定時器，處理時間

from opencv_engine import opencv_engine

class video_controller_2(object):
    def __init__(self, video_path, ui):
        self.video_path = video_path
        self.ui = ui
        self.qpixmap_fix_width = 560 # 16x9 = 1920x1080 = 1280x720 = 800x450
        self.qpixmap_fix_height = 315
    ...
    def __update_label_frame(self, frame):       
        ...
        self.ui.label_videoframe_2.setPixmap(self.qpixmap)
        # self.ui.label_videoframe_2.setAlignment(QtCore.Qt.AlignLeft | QtCore.Qt.AlignTop) # up and left
        self.ui.label_videoframe_2.setAlignment(QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter) # Center
